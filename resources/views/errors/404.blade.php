...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | Pendekin</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="title">Kehilangan arah?</h1>
        <p class="desc">Link pendek yang Anda tuju tidak ditemukan. Mungkin sudah dihapus, kedaluwarsa, atau Anda salah mengetik URL.</p>
